const Terms = () => {
	return (
		<div className="termsAnimation fixed top-0 z-0 flex h-screen w-full cursor-default items-start justify-center pt-14">
			<div className="container flex h-full flex-col items-center justify-start">
				<div className="flex h-full w-full flex-col items-center justify-center p-1 lg:h-[512px]">
					<div className="flex h-full w-full flex-col items-center justify-start gap-5 overflow-y-auto">
						<div className="border-b-2 border-hotely-gd py-2">
							<svg
						...
						<div className="flex flex-col gap-5 text-hotely-lt-med-gy">
							<div className="w-full text-center text-2xl font-medium text-hotely-lt-med-gy">
								<span>Terms and Disclaimer Agreement</span>
							</div>

							<div className="w-full text-center text-xl">
								The information provided by Hotely ("we," "us," or "our") on
								hotely.sebastianlacoste.com (the "Site") and our mobile
								application is for general informational purposes only. All
								information on the Site and our mobile application is provided
								...
								<span className="font-medium">
									...
									OF THE SITE OR OUR MOBILE APPLICATION OR RELIANCE ON ANY
									INFORMATION PROVIDED ON THE SITE AND OUR MOBILE APPLICATION.
